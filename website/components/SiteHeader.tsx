      ...
      <div className="mx-auto flex h-16 max-w-[1120px] items-center justify-between px-6 md:px-10">
        ...
        <div className="flex items-center gap-4">
          <a
            ...
            aria-label="LiAuth on GitHub"
            className="text-fg-2 transition-colors duration-150 hover:text-white"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex h-9 items-center bg-white px-4 text-sm font-semibold text-black transition-colors duration-150 hover:bg-neutral-300"
          >
            Download
          </a>
        </div>
